        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 pb-12 border-b border-gray-700 dark:border-slate-800">
          ...
          <div>
            ...
            <div className="space-y-2 mb-4">
              ...
              <a href="https://wa.me/5511994599115" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[13px] text-gray-400 dark:text-slate-500 hover:text-white transition-colors no-underline">
            ...
            <div className="flex gap-2.5">
              {[
                { label: 'Instagram', href: 'https://www.instagram.com/cargafybr/', icon: <><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="0.5" fill="currentColor" /></> },
              ].map((s) => (
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label} className="w-[34px] h-[34px] bg-gray-800 dark:bg-slate-800 border border-gray-700 dark:border-slate-700 rounded-lg flex items-center justify-center hover:bg-brand-500 hover:border-brand-500 transition-all no-underline group">
              ...
              <a href="https://wa.me/5511994599115" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-[34px] h-[34px] bg-gray-800 dark:bg-slate-800 border border-gray-700 dark:border-slate-700 rounded-lg flex items-center justify-center hover:bg-brand-500 hover:border-brand-500 transition-all no-underline group">
